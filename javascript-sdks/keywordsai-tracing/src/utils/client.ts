...
/**
 * KeywordsAI client interface for span management and tracing operations.
 * 
 * This client provides methods to:
 * - Get current trace and span IDs
 * - Update span attributes and KeywordsAI parameters
 ...
 * ```
 */
export interface KeywordsAIClient {
  /**
  ...
  /**
   * Update the current span with new attributes, name, status, or KeywordsAI parameters
 ...
 */
class KeywordsAIClientImpl implements KeywordsAIClient {
  private readonly tracerName = "@keywordsai/tracing";
...
// Singleton instance
let _clientInstance: KeywordsAIClient | undefined;
 ...
 * ```
 */
export function getClient(): KeywordsAIClient {
  if (!_clientInstance) {
