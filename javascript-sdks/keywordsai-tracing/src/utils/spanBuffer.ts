...
class SpanBufferImpl implements SpanBuffer {
  ...
  private readonly tracer = trace.getTracer("@keywordsai/tracing");
  ...
  createSpan(
    ...
    console.debug(
      `[KeywordsAI] Buffered span: ${name} (total: ${this.spans.length})`
    );
  }
