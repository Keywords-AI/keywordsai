...
class KeywordsAILogger:
    ...
    def log_success(
        ...
        try:
            print_verbose(
                f"Keywords AI Logging - Enters logging function for model {model}"
            )
            ...
            if hasattr(response_obj, "model_dump"):
                response_obj = response_obj.model_dump(mode="json")
            ...
            response = requests.post(url=self.api_base, headers=headers, json=payload)
