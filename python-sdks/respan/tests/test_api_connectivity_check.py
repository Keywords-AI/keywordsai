...
This script checks if the Respan API server is accessible and provides
...
async def check_api_connection():
    ...
    print("🔍 Respan API Connection Check")
    print("=" * 50)
    ...
    try:
        ...
        print("   1. Make sure the Respan server is running")
...
def main():
    ...
    if result:
        ...
        print("   python -m pytest tests/ -k 'not test_respan_api_integration' -v")
