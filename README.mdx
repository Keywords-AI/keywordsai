...
### What for?
Perform telemetry in LLM applications using [openllmetry](https://github.com/traceloop/openllmetry)
...
def my_workflow():
    ...
    my_task()
```
For a comprehensive example, see the [basic_workflow_test.py](https://github.com/KeywordsAI/python-sdks/blob/main/keywordsai-tracing/tests/tracing_tests/basic_workflow_test.py) file.

Guide for recreating the example step by step can be found [here](https://docs.traceloop.com/getting-started/python/instrument-your-python-code-with-traceloop-and-openllmetry/).
## Keywords AI Types
### What for?
